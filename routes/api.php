...
Route::middleware(['CheckModuleActive'])->prefix('modules/{id}')->group(function () {
    ...
    Route::get("/deactivate", [UserModuleController::class, "deActivateModule"])->name("module.deActivate");

});

Route::get("modules/{id}/activate", [UserModuleController::class, "activateModule"])->name("module.activate");
